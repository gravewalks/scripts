...
do
	...
	createMenu = function(arguments)
		...
		local function initiate_component()
			...
			if not syn.protect_gui and protect_gui then
			    protect_gui(menu_screen_gui)
			elseif syn.protect_gui then
		        syn.protect_gui(menu_screen_gui)
			end
			menu_screen_gui["Parent"], bind_name = findService["CoreGui"] or gethui(), generateRandomString()
